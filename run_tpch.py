...
def measure_time(statement_callable):
    ...
    # Execute the statement callable and store the result
    ...
    # Report the CPU time used and real time elapsed
...
with duckdb.connect("~/ddbdata/tpch_sf100.db", read_only=True) as con:
